...
saldos_novos = {
    "Percentual de provisões em relação à carteira de crédito do Sistema Financeiro Nacional": 13645,
    "Percentual de provisões em relação à carteira de crédito das instituições financeiras sob controle público": 13666,
    "Percentual de provisões em relação à carteira de crédito das instituições financeiras sob controle privado": 13684,
    "Percentual de provisões em relação à carteira de crédito das instituições financeiras sob controle privado nacional": 13672,
    "Percentual de provisões em relação à carteira de crédito das instituições financeiras sob controle estrangeiro": 13678,
