...
saldos_novos = {
    "Spread médio - Total": 20783,
    "Spread médio não rotativo - Total": 27631,
    "Spread médio - Pessoas jurídicas - Total": 20784,
    "Spread médio não rotativo - Pessoas jurídicas - Total": 27632,
    "Spread médio - Pessoas físicas - Total": 20785,
    "Spread médio não rotativo - Pessoas físicas - Total": 27633,

}

saldos_novos1 = {
    "Spread médio - Total": 20786,
    "Spread médio não rotativo - Total": 27634,
    "Spread médio - Pessoas jurídicas - Total": 20787,
    "Spread médio não rotativo - Pessoas jurídicas - Total": 27635,
    "Spread médio - Pessoas físicas - Total": 20809,
    "Spread médio não rotativo - Pessoas físicas - Total": 27636,

}
saldos_novos2 = {
    "Spread médio - Total": 20825,
    "Spread médio - Pessoas jurídicas - Total": 20826,
    "Spread médio - Pessoas físicas - Total": 20837,
...
st.sidebar.header('Spread')
opcoes_selecao1 = st.sidebar.multiselect('1-Selecione :', list(saldos_novos.keys()))

# Multiselect para o segundo grupo de dicionários
st.sidebar.header('Spread com recursos livres')
opcoes_selecao2 = st.sidebar.multiselect('2-Selecione :', list(saldos_novos1.keys()))

# Multiselect para o terceiro grupo de dicionários
st.sidebar.header('Spread com recursos direcionados')
opcoes_selecao3 = st.sidebar.multiselect('3-Selecione :', list(saldos_novos2.keys()))
