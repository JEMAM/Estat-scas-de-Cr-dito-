...
saldos_novos = {
    "Spread ICC - Total": 27443,
    "Spread do ICC - Crédito não rotativo - Total": 27695,
    "Spread ICC - Pessoas jurídicas - Total": 27444,
    "Spread do ICC - Crédito não rotativo - Pessoas jurídicas": 27696,
    "Spread ICC - Pessoas físicas - Total": 27445,
    "Spread do ICC - Crédito não rotativo - Pessoas físicas": 27697,

}

saldos_novos1 = {
    "Spread ICC - Recursos livres - Total": 27446,
    "Spread ICC - Recursos livres - Pessoas jurídicas - Total": 27447,
    "Spread ICC - Recursos livres - Pessoas físicas - Total": 27448,
    "Spread do ICC - Crédito não rotativo - Recursos livres": 27698,
    "Spread do ICC - Crédito não rotativo - Recursos livres - Pessoas físicas": 27700,
    "Spread do ICC - Crédito não rotativo - Recursos livres - Pessoas jurídicas": 27699,

}
saldos_novos2 = {
    "Spread ICC - Recursos direcionados - Total": 27449,
    "Spread ICC - Recursos direcionados - Pessoas jurídicas - Total": 27450,
    "Spread ICC - Recursos direcionados - Pessoas físicas - Total": 27451,
...
#st.sidebar.header('Spread do ICC')
opcoes_selecao1 = st.sidebar.multiselect('Spread do ICC', list(saldos_novos.keys()))

# Multiselect para o segundo grupo de dicionários
#st.sidebar.header('Spread do ICC com recursos livres')
opcoes_selecao2 = st.sidebar.multiselect('Spread do ICC com recursos livres:', list(saldos_novos1.keys()))

# Multiselect para o terceiro grupo de dicionários
#st.sidebar.header('Spread do ICC com recursos direcionados:')
opcoes_selecao3 = st.sidebar.multiselect('Spread do ICC com recursos direcionados:', list(saldos_novos2.keys()))




# Juntando todas as opções selecionadas
opcoes_selecao = opcoes_selecao1 + opcoes_selecao2 + opcoes_selecao3

# Carregar dados selecionados
dados_selecionados = {
    nome: carregar_dados(codigo)
    for dicionario in [saldos_novos, saldos_novos1, saldos_novos2]
